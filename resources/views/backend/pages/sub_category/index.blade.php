...
@section('content')
                                ...
                                @isset($data['sub_categories'])
                                    @foreach ($data['sub_categories'] as $sub_category)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="{{ $sub_category->Status($sub_category->status) }}">
                                                    {{ ucwords($sub_category->status) }}</span>
                                            </td>
                                            <td>
                                                {{ $sub_category->Fun($sub_category->created_at) }}
                                            </td>
                                            <td>
                                        ...
                                        <!-- Modal Edit Category -->
                                        <div class="modal" id="edit{{ $sub_category->slug }}">
                                            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                                <div class="modal-content modal-content-demo">
                                                    ...
                                                    <form
                                                        action="{{ route('admin.sub_category.update', $sub_category->slug) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 col-lg-6 col-md-6 col-xl-6">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value="{{ $sub_category->getTranslation('title', 'ar') }}"
                                                                ...
                                                                <div class="col-12 col-lg-6 col-md-6 col-xl-6">
                                                                    <div class="">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value="{{ $sub_category->getTranslation('title', 'en') }}"
                                                                ...
                                                                <div class="col-12 col-lg-12 col-md-12 col-xl-12">
                                                                    <div class="mt-3">
                                                                        ...
                                                                        <textarea rows="5" class="form-control @error('description') is-invalid @enderror" name="description"
                                                                            placeholder="{{ __('web.description') }}">{{ $sub_category->getTranslation('description', 'ar') }}</textarea>
                                                                        @error('description')
                                                                            <small class="text-danger">{{ $message }}</small>
                                                                        @enderror
                                                                    </div>
                                                                ...
                                                                <div class="col-12 col-lg-12 col-md-12 col-xl-12">
                                                                    <div class="mt-3">
                                                                        ...
                                                                        <textarea rows="5" class="form-control @error('description_en') is-invalid @enderror" name="description_en"
                                                                            placeholder="{{ __('web.description_en') }}">{{ $sub_category->getTranslation('description', 'en') }}</textarea>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-control" name="status"
                                                                            ...
                                                                            <option value="inactive"
                                                                                {{ $sub_category->status == 'inactive' ? 'selected' : '' }}>
                                                                ...
                                                                <div class="col-12 col-lg-6 col-md-6 col-xl-6 mt-3">
                                                                    <div class="mb-3">
                                                                        <label for=""
                                                                            class="form-label">{{ __('web.category') }}</label>
                                                                        <select class="form-control" name="category_id"
                                                                            id="category_id">
                                                                            <option selected disabled>
                                                                                {{ __('web.select_category') }}</option>
                                                                            @isset($data['categories'])
                                                                                @foreach ($data['categories'] as $category)
                                                                                    <option value="{{ $category->id }}"
                                                                                        {{ $category->slug == $sub_category->category->slug ? 'selected' : '' }}>
                                        ...
                                        <div class="modal" id="delete{{ $sub_category->slug }}">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content modal-content-demo">
                                                    <div class="modal-header">
                                                        <h6 class="modal-title">{{ __('web.delete_sub_category') }}</h6>
                                                        <button aria-label="Close" class="close" data-dismiss="modal"
                                                            type="button"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <form
                                                        action="{{ route('admin.sub_category.destroy', $sub_category->slug) }}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('delete')
                                                        <div class="modal-body">
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{ __('web.create_sub_category') }}</h6><button aria-label="Close"
