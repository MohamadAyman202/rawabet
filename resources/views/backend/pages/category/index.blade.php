...
@section('content')
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a class="modal-effect btn btn-primary btn-md" data-toggle="modal"
                        href="#modaldemo8">{{ __('web.create_category') }}</a>
                </div>
                <div class="card-body">
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="modal-effect btn btn-primary btn-sm" data-toggle="modal"
                                                    href="#edit{{ $category->slug }}">{{ __('web.edit') }}</a>

                                                <a class="modal-effect btn btn-danger btn-sm" data-toggle="modal"
                                                    href="#delete{{ $category->slug }}">{{ __('web.delete') }}</a>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                                <div class="modal-content modal-content-demo">
                                                    <div class="modal-header">
                                                        <h6 class="modal-title">{{ __('web.edit_category') }}</h6><button
                                                                ...
                                                                <div class="col-12 col-lg-12 col-md-12 col-xl-12">
                                                                    <div class="mt-3">
                                                                        ...
                                                                        <textarea rows="5" class="form-control @error('description') is-invalid @enderror" name="description"
                                                                            placeholder="{{ __('web.description') }}">{{ $category->getTranslation('description', 'ar') }}</textarea>
                                                                        @error('description')
                                                                            <small class="text-danger">{{ $message }}</small>
                                                                        @enderror
                                                                    </div>
                                                                ...
                                                                <div class="col-12 col-lg-12 col-md-12 col-xl-12">
                                                                    <div class="mt-3">
                                                                        ...
                                                                        <textarea rows="5" class="form-control @error('description_en') is-invalid @enderror" name="description_en"
                                                                            placeholder="{{ __('web.description_en') }}">{{ $category->getTranslation('description', 'en') }}</textarea>
                                        ...
                                        <div class="modal" id="delete{{ $category->slug }}">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content modal-content-demo">
                                                    <div class="modal-header">
                                                        <h6 class="modal-title">{{ __('web.delete_category') }}</h6><button
                                                            aria-label="Close" class="close" data-dismiss="modal"
                                                            type="button"><span aria-hidden="true">&times;</span></button>
                                                    </div>
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{ __('web.create_category') }}</h6><button aria-label="Close"
