...
@section('content')
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a class="modal-effect btn btn-primary btn-md"  data-toggle="modal"
                        href="#modaldemo8">{{ __('web.create_measuring_unit') }}</a>
                </div>
                <div class="card-body">
                                ...
                                @isset($measuring_units)
                                    @foreach ($measuring_units as $measuring_unit)
                                        <tr>
                                            ...
                                            <td>{{ $measuring_unit->title }}</td>
                                            <td>
                                                {{ $measuring_unit->Fun($measuring_unit->created_at) }}
                                            </td>
                                            <td>
                                                {{ $measuring_unit->Fun($measuring_unit->updated_at) }}
                                            </td>
                                            <td>
                                                <a class="modal-effect btn btn-primary btn-sm" data-effect="effect-just-me"
                                                    data-toggle="modal"
                                                    href="#edit{{ $measuring_unit->slug }}">{{ __('web.edit') }}</a>

                                                <a class="modal-effect btn btn-danger btn-sm" data-effect="effect-just-me"
                                                    data-toggle="modal"
                                                    href="#delete{{ $measuring_unit->slug }}">{{ __('web.delete') }}</a>
                                            </td>
                                        </tr>

                                        <!-- Modal Edit Category -->
                                        <div class="modal" id="edit{{ $measuring_unit->slug }}">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content modal-content-demo">
                                                    <div class="modal-header">
                                                        <h6 class="modal-title">{{ __('web.edit_measuring_unit') }}</h6><button
                                                            aria-label="Close" class="close" data-dismiss="modal"
                                                            type="button"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <form
                                                        action="{{ route('admin.measuring_units.update', $measuring_unit->slug) }}"
                                                                ...
                                                                <div class="col-12 col-lg-12 col-md-12 col-xl-12">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value="{{ $measuring_unit->getTranslation('title', 'ar') }}"
                                                                ...
                                                                <div class="col-12 col-lg-12 col-md-12 col-xl-12">
                                                                    <div class="mt-3">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value="{{ $measuring_unit->getTranslation('title', 'en') }}"
                                        ...
                                        <div class="modal" id="delete{{ $measuring_unit->slug }}">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content modal-content-demo">
                                                    <div class="modal-header">
                                                        <h6 class="modal-title">{{ __('web.delete_measuring_unit') }}</h6>
                                                        <button aria-label="Close" class="close" data-dismiss="modal"
                                                            type="button"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <form
                                                        action="{{ route('admin.measuring_units.destroy', $measuring_unit->slug) }}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('delete')
                                                        <div class="modal-body">
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{ __('web.create_measuring_unit') }}</h6><button aria-label="Close"
                        class="close" data-dismiss="modal" type="button"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <form action="{{ route('admin.measuring_units.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
