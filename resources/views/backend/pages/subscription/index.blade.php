...
@section('content')
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a class="modal-effect btn btn-primary btn-md" data-toggle="modal"
                        href="#modaldemo8">{{ __('web.create_subscriptions') }}</a>
                </div>
                <div class="card-body">
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">{{ __('web.count_day') }}</th>
                                ...
                                @isset($subscriptions)
                                    @foreach ($subscriptions as $subscription)
                                        <tr>
                                            ...
                                            <td>{{ $subscription->count_day }}</td>
                                            <td>
                                                <span class="{{ $subscription->Status($subscription->status) }}">
                                                    {{ ucwords($subscription->status) }}</span>
                                            </td>
                                            <td>
                                                {{ $subscription->Fun($subscription->created_at) }}
                                            </td>
                                            <td>
                                                {{ $subscription->Fun($subscription->updated_at) }}
                                            </td>
                                            <td>
                                                <a class="modal-effect btn btn-primary btn-sm" data-toggle="modal"
                                                    href="#edit{{ $subscription->slug }}">{{ __('web.edit') }}</a>

                                                <a class="modal-effect btn btn-danger btn-sm" data-toggle="modal"
                                                    href="#delete{{ $subscription->slug }}">{{ __('web.delete') }}</a>
                                            </td>
                                        </tr>

                                        <!-- Modal Edit Category -->
                                        <div class="modal" id="edit{{ $subscription->slug }}">
                                            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                                <div class="modal-content modal-content-demo">
                                                    <div class="modal-header">
                                                        <h6 class="modal-title">{{ __('web.edit_sub_category') }}</h6><button
                                                            aria-label="Close" class="close" data-dismiss="modal"
                                                            type="button"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <form
                                                        action="{{ route('admin.subscriptions.update', $subscription->slug) }}"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 col-lg-6 col-md-6 col-xl-6">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value="{{ $subscription->getTranslation('title', 'ar') }}"
                                                                ...
                                                                <div class="col-12 col-lg-6 col-md-6 col-xl-6">
                                                                    <div class="">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value="{{ $subscription->getTranslation('title', 'en') }}"
                                                                ...
                                                                <div class="col-12 col-lg-12 col-md-12 col-xl-12">
                                                                    <div class="mt-3">
                                                                        ...
                                                                        <textarea rows="5" id="editor" class="form-control @error('description') is-invalid @enderror"
                                                                            name="description" placeholder="{{ __('web.description') }}">{{ $subscription->getTranslation('description', 'ar') }}</textarea>
                                                                        @error('description')
                                                                            <small class="text-danger">{{ $message }}</small>
                                                                        @enderror
                                                                    </div>
                                                                ...
                                                                <div class="col-12 col-lg-12 col-md-12 col-xl-12">
                                                                    <div class="mt-3">
                                                                        ...
                                                                        <textarea rows="5" id="editor1" class="form-control @error('description_en') is-invalid @enderror"
                                                                            name="description_en" placeholder="{{ __('web.description_en') }}">{{ $subscription->getTranslation('description', 'en') }}</textarea>
                                                                ...
                                                                <div class="col-12 col-lg-4 col-md-4 col-xl-4 mt-3">
                                                                    <div class="mb-3">
                                                                        <label for=""
                                                                            class="form-label">{{ __('web.price') }}</label>
                                                                ...
                                                                <div class="col-12 col-lg-4 col-md-4 col-xl-4 mt-3">
                                                                    <div class="mb-3">
                                                                        <label for=""
                                                                            class="form-label">{{ __('web.count_day') }}</label>
                                                                        <input type="number" name="count_day" id="count_day"
                                                                            class="form-control @error('count_day') is-invalid @enderror"
                                                                            placeholder="{{ __('web.count_day') }}"
                                                                            aria-describedby="helpId" min="0"
                                                                            value="{{ $subscription->count_day }}" />
                                                                        @error('count_day')
                                                                            <small id="helpId"
                                                                                class="text-danger">{{ $message }}</small>
                                                                        @enderror
                                        ...
                                        <div class="modal" id="delete{{ $subscription->slug }}">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content modal-content-demo">
                                                    <div class="modal-header">
                                                        <h6 class="modal-title">{{ __('web.delete_subscriptions') }}</h6>
                                                        <button aria-label="Close" class="close" data-dismiss="modal"
                                                            type="button"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <form
                                                        action="{{ route('admin.subscriptions.destroy', $subscription->slug) }}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('delete')
                                                        <div class="modal-body">
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{ __('web.create_subscriptions') }}</h6><button aria-label="Close"
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 col-md-6 col-xl-6">
                                ...
                                <div class="">
                                    ...
                                    <input class="form-control @error('title') is-invalid @enderror" type="text"
                                        name="title" value="" placeholder="{{ __('web.title_cate') }}" />
                                    @error('title')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-lg-6 col-md-6 col-xl-6">
                                <div class="">
                                    ...
                                    <input class="form-control @error('title_en') is-invalid @enderror" type="text"
                                        name="title_en" value="" placeholder="{{ __('web.title_cate_en') }}" />
                                    @error('title_en')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-lg-12 col-md-12 col-xl-12">
                                <div class="mt-3">
                                    ...
                                    <textarea id="editor" rows="5" class="form-control @error('description') is-invalid @enderror"
                                        name="description" placeholder="{{ __('web.description') }}">{{ old('title_en') }}</textarea>
                                    @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-lg-12 col-md-12 col-xl-12">
                                <div class="mt-3">
                                    ...
                                    <textarea rows="5" id="editor1" class="form-control @error('description_en') is-invalid @enderror"
                                        name="description_en" placeholder="{{ __('web.description_en') }}">{{ old('description_en') }}</textarea>
                                    @error('description_en')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-lg-4 col-md-4 col-xl-4 mt-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="price" id="price"
                                        class="form-control @error('price') is-invalid @enderror"
                                        placeholder="{{ __('web.price') }}" aria-describedby="helpId" />
                                    @error('price')
                            ...
                            <div class="col-12 col-lg-4 col-md-4 col-xl-4 mt-3">
                                <div class="mb-3">
                                    <label for="" class="form-label">{{ __('web.count_day') }}</label>
                                    <input type="number" name="count_day" id="count_day" min="0" value="0"
                                        class="form-control @error('count_day') is-invalid @enderror"
                                        placeholder="{{ __('web.count_day') }}" aria-describedby="helpId" />
                                    @error('count_day')
                                        <small id="helpId" class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
